...
export const neutralTheme = defineTheme({
  ...
  // Typography: Aurora uses Suisse BP Intl (commercial) for body/headings and
  // Geist Mono for micro-labels/pills. Geist (free, same spirit as Suisse) is
  // already loaded in layout.tsx via next/font/google as --font-geist-sans /
  // --font-geist-mono — reuse those CSS vars instead of a second font import.
  ...
  tokens: {
    ...
    // Aurora quiet-luxury accent: deep olive #404e38, sampled from the
    // "Let's go!" / Agents-panel background in the Figma file. Dark mode
    // gets a lighter olive tint for legibility (no dark screens in the
    // source design — this is a reasonable extrapolation).
    '--color-accent':       ['#404e38', '#a8c29f'],
    '--color-accent-muted': ['#eef1ea', '#2b3527'],
    ...
    '--color-text-accent':    ['#404e38', '#a8c29f'],
    '--color-on-dark':    '#ffffff',
    '--color-on-light':   '#171717',
    // Contrast: white text sits on the olive accent in both modes (matches
    // the "Let's go!" button in the source design)
    ...
    // Icon
    '--color-icon-accent':    ['#404e38', '#a8c29f'],
    ...
    // =========================================================================
    // Radius — matched to Aurora's extracted scale: pills/buttons ~13px,
    // composer bar/cards ~16px, large panels (Agents HUD) ~20px.
    // =========================================================================
    '--radius-none': '0.25rem',
    '--radius-inner': '0.5rem',
    '--radius-element': '0.8125rem',
